            ...
            while (true) {
                ...
                if (inputSize > 0) {
                    ...
                    if (packet2net.isTCP()) {
                        ...
                        //实现抓包功能咯
                        Log.i("NetKnightService", "ipAndPort=" + ipAndPort);
                        ...
                        MyLog.logd(this, "暂时不支持UDP数据!!"+( packet2net.isUDP()));
                        isDataSend = false;
                    }
                    else {

                        MyLog.logd(this, "暂时不支持其他类型数据!!"+( packet2net.isUDP()));
                        isDataSend = false;
                    }
                } else {
                    //与其release 还不如直接复用
...
//                    ByteBufferPool.release(buffer2Net);
                ...
                if (buffer4Net != null) {
                    ...
                    Log.i("NetKnight service", " 将数据返回到应用中:" + buffer4Net.toString());
                    buffer4Net.flip();
